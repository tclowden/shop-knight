...
export default function CustomersPage() {
  ...
  async function createCustomer(e: React.FormEvent) {
    ...
    setName(''); setEmail(''); setPhone(''); setPaymentTerms('Net 30'); setAdditionalFeePercent('0');
    await load();
  }
  ...
  return (
    <main className="mx-auto max-w-7xl bg-[#f5f7fa] p-6 text-slate-800 md:p-8">
      ...
      <form onSubmit={createCustomer} className="mb-4 grid grid-cols-1 gap-2 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-6">
