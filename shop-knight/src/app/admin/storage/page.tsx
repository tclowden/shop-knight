...
type StorageItem = { id: string; itemNumber: string; name: string; description: string | null; active: boolean; photoUrl: string | null; rack: { id: string; name: string; code?: string | null } | null; space: { id: string; name: string; code?: string | null } | null; bin: { id: string; name: string; code?: string | null } | null };
