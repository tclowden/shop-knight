    ...
    <main className="mx-auto max-w-6xl p-8">
      ...
      <form onSubmit={createOpportunity} className="mb-4 grid grid-cols-1 gap-2 rounded border border-zinc-800 p-3 md:grid-cols-5">
        <label className="text-sm">
          ...
          <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Opportunity name" className="w-full rounded border border-zinc-700 bg-white p-2 text-zinc-900 placeholder:text-zinc-500" required />
        </label>
        ...
        <button className="rounded bg-blue-600 px-3 py-2 md:self-end">Create Opportunity</button>
      </form>
