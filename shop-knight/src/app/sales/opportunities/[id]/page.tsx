        ...
        <div className="mb-4 rounded border border-zinc-800 p-3 text-sm">
          ...
          {!editing ? (
            ...
            <form onSubmit={saveOpportunity} className="grid grid-cols-1 gap-2 md:grid-cols-2">
              ...
              <label className="text-sm"><span className="mb-1 block text-zinc-300">Expected Close Date</span><input value={expectedCloseDate} onChange={(e) => setExpectedCloseDate(e.target.value)} type="date" className="w-full rounded border border-zinc-700 bg-white p-2 text-zinc-900" /></label>
              <label className="text-sm"><span className="mb-1 block text-zinc-300">Due Date</span><input value={dueDate} onChange={(e) => setDueDate(e.target.value)} type="date" className="w-full rounded border border-zinc-700 bg-white p-2 text-zinc-900" /></label>
              <label className="text-sm"><span className="mb-1 block text-zinc-300">In-Hand Date</span><input value={inHandDate} onChange={(e) => setInHandDate(e.target.value)} type="date" className="w-full rounded border border-zinc-700 bg-white p-2 text-zinc-900" /></label>
